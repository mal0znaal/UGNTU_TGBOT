...
def translit(text: str) -> str:
    """Транслитерирует текст для cv2.putText, который не поддерживает кириллицу."""
    mapping = {
...
def save_debug_image(source_rgb: np.ndarray, crop_bgra: np.ndarray, cls_info: dict, output_dir: Path):
    """Сохраняет исходное изображение, вырезанный объект и классификацию."""
    try:
        ...
        logger.exception("Не удалось сохранить отладочное изображение")
